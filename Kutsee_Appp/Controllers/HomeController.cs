    ...
    public class HomeController : Controller
    {
        ...
        private void E_mail(Guest guest)
        {
            try
            {
                ...
                WebMail.UserName = "sanjkashevcenko@gmail.com";
                WebMail.Password = "Aleksand200319";
                WebMail.From = "sanjkashevcenko@gmail.com";
                WebMail.Send("sanjkashevcenko@gmail.com", "Vastus kutsele", guest.Name + " vastas " + ((guest.WillAttend ?? false) ? "tuleb peole " : "ei tule peole"));
